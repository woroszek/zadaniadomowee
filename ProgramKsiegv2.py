        ...
        if is_or_not(item) == True:
            for i in warehouse:
                ...
                if i[0] == item and balance - quantity * cost >= 0:
                    ...
                    i[1]['ilosc'] += quantity
                    history.append(f'Zaaktualizowano ilosc produktu {item} o {quantity}')
    ...
    if command == 'sk':
        try:
            with open('balance.txt','r') as file:
                print(f'Stan Twojego konta to: {file.read()}')
        except:
